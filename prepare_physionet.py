...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="data/raw/sleep-edf-database-expanded-1.0.0/sleep-cassette/",
                        help="File path to the PSG and annotation files.")
    parser.add_argument("--output_dir", type=str, default="data/SleepEDF/",
