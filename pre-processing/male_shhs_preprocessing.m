...
% Import the data
shhs1dataset = readtable("./data/shhs/shhs1-dataset-0.15.0.csv", opts);
clear opts
%% Variable Setting %%
% data_dir MUST include both psg and hypnogram file!
data_dir = "./data/shhs/polysomnography/edfs/shhs1/";
annot_dir = "./data/shhs/polysomnography/annotations-events-nsrr/shhs1/";

mannual_starting_point = 0;
male_target_idx = (find((shhs1dataset.oahi < 5 & shhs1dataset.overall_shhs1 == 7 & shhs1dataset.gender == 1)));
%%
target_files = string(shhs1dataset.nsrrid(male_target_idx));
...
psg_path = './male_SHHS/psg/';
hyp_path = './male_SHHS/hyp/';
